...
impl iter::Sum for u512 {
    fn sum<I: Iterator<Item = Self>>(iter: I) -> Self {
        iter.fold(Self::ZERO, |a, b| a + b)
    }
}

impl<'a> iter::Sum<&'a u512> for u512 {
    fn sum<I: Iterator<Item = &'a Self>>(iter: I) -> Self {
        iter.fold(Self::ZERO, |a, b| a + b)
    }
}

impl iter::Product for u512 {
    fn product<I: Iterator<Item = Self>>(iter: I) -> Self {
        iter.fold(Self::ONE, |a, b| a * b)
    }
}

impl<'a> iter::Product<&'a u512> for u512 {
...
impl u512 {
    ...
    pub const fn as_u384(self) -> u384 {
        u384 { inner: self.inner.as_cast_unsigned() }
    }
    ...
    /// ```
    /// # use wider_primitives::*;
    #[doc = concat!("assert_eq!(", typename!(), "::MAX.as_u512(), u512::MAX);")]
    /// ```
    /// [numeric_cast]: <https://doc.rust-lang.org/reference/expressions/operator-expr.html#numeric-cast>
